locals {
  ...
  "kafka-to-iceberg-batch-saptce-multi-1" = {
    ...
    glue_job_arguments = {
      ...
      "--source_kafka_topic"       = "${local.env}.saptce.multi-1.raw"
      ...
      "--sink_iceberg_database"            = "lh_sap_tce_raw_dev"
      "--sink_iceberg_warehouse"           = "s3://minerva-dev-src-corp/current/prd/raw/sap_tce/"
